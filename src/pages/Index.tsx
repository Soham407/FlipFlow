  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        ...
        <meta
          property="og:title"
          content="FlipFlow - Interactive PDF Flipbooks"
        />
        <meta
      ...
      <section className="container mx-auto px-4 pt-20 pb-24 text-center">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Create stunning, interactive flipbooks from your PDFs in seconds.
            Perfect for magazines, catalogs, portfolios, and more.
          </p>
      ...
      <section className="container mx-auto px-4 py-24 bg-muted/30">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Powerful features to create professional flipbooks that engage your
            audience
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Drag and drop your PDF or browse to upload. We'll convert it to
                a beautiful flipbook instantly.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Optimized rendering engine ensures smooth page turns and instant
                loading, even on mobile devices.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Share your flipbooks with a single link. Works perfectly across
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Powerful dashboard to manage all your flipbooks. Search, sort,
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Enterprise-grade security. Your files are encrypted and stored
                safely in the cloud.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="border-2 hover:border-primary/50 transition-all hover:shadow-lg">
            <CardContent className="pt-6">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Realistic page-turning animations and stunning visual effects
      ...
      <section className="container mx-auto px-4 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground">
            Scalable pricing for professionals of all stages
          </p>
        </div>
              ...
              <CardContent className="pt-6 pb-8 flex-1 flex flex-col">
                <div className="mb-6">
                  ...
                  <p className="text-muted-foreground text-sm">
                    {key === "FREE"
                      ? "Perfect for trying out FlipFlow"
                      : key === "STARTER"
                ...
                <ul className="space-y-3 mb-8 flex-1">
                  {plan.features.map((feature, i) => (
                    <li key={i} className="flex items-start gap-2">
                      ...
                      <span className={key !== "FREE" ? "font-medium" : ""}>
                        {feature}
                      </span>
                    </li>
                  ))}
        ...
        <Card className="border-2 bg-gradient-to-br from-primary/5 via-accent/5 to-primary/5">
          <CardContent className="pt-12 pb-12 text-center">
            ...
            <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of users who are already using FlipFlow to share
              their content in a more engaging way.
            </p>
            <Button asChild size="lg" className="text-lg px-8 h-12">
